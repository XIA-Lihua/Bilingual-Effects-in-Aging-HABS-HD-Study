...
```{r}
HABS_HD_cross_sectional$DSF_Total[HABS_HD_cross_sectional$DSF_Total == -9999] <- NA 
HABS_HD_cross_sectional$DSB_Total[HABS_HD_cross_sectional$DSB_Total == -9999] <- NA
```
...
```{r}
HABS_HD_longitudinal$DSF_Total[HABS_HD_longitudinal$DSF_Total == -9999] <- NA 
HABS_HD_longitudinal$DSB_Total[HABS_HD_longitudinal$DSB_Total == -9999] <- NA
```
```{r}
# Reverse Trails A and B so higher = better
